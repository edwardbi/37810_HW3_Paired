...
We see that the R squared value is 0.6024, which means that hp is able to explain 60.24% of the variations in mpg. Also, the intercept of hp is -0.07, with P value < 0.05, this means that a unit increase in hp will results in decrease in mpg by 0.07 units, and this estimation is significant.